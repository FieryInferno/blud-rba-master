...
class RKA1Controller extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $whereRka = function ($query) use($user){
            $query->where('kode_rka', Rka::KODE_RKA_1);
        ...
        return view('admin.rka.rka1.index', compact('rka'));
    }
    ...
    public function create()
    {
        ...
        $kodeUnitKerja = $rka1->pluck('kode_unit_kerja')->toArray();
        ...
        return view('admin.rka.rka1.create', compact('unitKerja', 'akun'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(RKA1Request $request)
    {
         try {
            DB::beginTransaction();
            $rka = $this->rka->create([
                'kode_rka' => Rka::KODE_RKA_1,
    ...
    public function edit($id)
    {
        ...
        return view('admin.rka.rka1.edit', compact('unitKerja', 'akun', 'rka', 'akunParent', 'kodeAkunRka'));
    }
    ...
    public function editPak($id)
    {
        ...
        return view('admin.rka.rka1.pak.edit', compact('unitKerja', 'akun', 'rka', 'akunParent'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(RKA1Request $request, $id)
    {
        try {
            DB::beginTransaction();
     ...
     * @return \Illuminate\Http\Response
     */
    public function updatePak(RKA1Request $request, $id)
    {
        try {
            DB::beginTransaction();
            $rka = $this->rka->find($id);
