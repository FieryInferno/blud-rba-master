...
use App\Http\Requests\RBA\RBA1Request;
...
class RBA1Controller extends Controller
{
    /**
     ...
     * Unit kerja repository.
     * 
     * @var RBARincianAnggaranRepository
     */
     ...
     * Unit kerja repository.
     * 
     * @var RBARincianSumberDanaRepository
     */
    ...
    public function index(Request $request)
    {
        ...
        $whereRba = function ($query) use ($user, $request) {
            $query->where('kode_rba', Rba::KODE_RBA_1);
        ...
        return view('admin.rba.rba1.index', compact('rba', 'unitKerja', 'totalAllRba'));
    }
    ...
    public function create()
    {
        ...
        $rba1 = $this->rba->get(['*'], $whereRba);
        $kodeUnitKerja = $rba1->pluck('kode_unit_kerja')->toArray();
        ...
        return view('admin.rba.rba1.create', compact('unitKerja', 'akun'));
    }
     ...
     * @return void
     */
    public function store(RBA1Request $request)
    {      
        try {
            DB::beginTransaction();
            $rba = $this->rba->create([
                'kode_rba' => Rba::KODE_RBA_1,
    ...
    public function edit($id)
    {
        ...
        return view('admin.rba.rba1.edit', compact('unitKerja', 'akun', 'rba', 'akunParent', 'kodeAkunRba', 'oldSumberDana'));
    }
    ...
    public function editPak($id)
    {
        ...
        $rba = $this->rba->getRbaUpdate($id, auth()->user()->statusAnggaran->id, Rba::KODE_RBA_1);
        ...
        return view('admin.rba.rba1.pak.edit', compact('unitKerja', 'akun', 'rba', 'akunParent', 'oldSumberDana', 'kodeAkunRba'));
    }

    /**
     * 
     */
    public function update(RBA1Request $request, $id)
    {
        try {
            DB::beginTransaction();
     ...
     * @return void
     */
    public function updatePak(RBA1Request $request, $id)
    {
         try {
            DB::beginTransaction();
            $rba = $this->rba->find($id);
