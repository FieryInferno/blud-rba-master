...
<div class="main-content">
  <section class="section">
      <div class="section-header">
          <h1>RBA Pendapatan - {{ auth()->user()->statusAnggaran->status_anggaran }}</h1>
      </div>
                  ...
                  <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <form class="form-inline">
                          ...
                          <a href="{{ route('admin.rba1.index') }}" class="btn btn-outline-danger mb-2"><i class="fa fa-reset"></i> Reset</a>
                        </form>
                          ...
                          <tbody>
                            @foreach ($rba as $item)
                              <tr>
                                ...
                                <td>
                                  @if (auth()->user()->statusAnggaran->status_perubahan == 'MURNI')
                                    <a href="{{ route('admin.rba1.edit', $item->id) }}" class="btn btn-sm btn-primary">
                                      <span class="fa fa-plus"></span> Pilih
                                    </a>
                                  @else
                                    <a href="{{ route('admin.rba1.edit_pak', $item->id) }}" class="btn btn-sm btn-primary">
                                      <span class="fa fa-plus"></span> Pilih
                                    </a>
                                  @endif
...
<form id="form-delete" action="{{ route('admin.rba1.destroy') }}" class="d-none" method="POST">
  @csrf
  @method('DELETE')
