...
<div class="main-content">
  <section class="section">
      ...
      <form action="{{ route('admin.rka1.update', $rka->id) }}" method="POST" id="form-rka">
      @csrf
      @method('PUT')
                          ...
                          <div class="tab-pane fade" id="sumber_dana" role="tabpanel" aria-labelledby="sumber-dana-tab">
                            <div class="row">
                              <div class="col">
                                ...
                                @else
                                  <button type="button" id="buttonSubmit" class="btn btn-secondary mt-3" disabled>
                                    <i class="fa fa-save"></i>
                                    Simpan
                                  </button>
                                @endif
  ...
  <script>
    $(document).ready(function () {
      ...
      $('#form-rka').on('submit', function (e) {
        ...
        $.ajax({
          type: "POST",
          url: "{{ route('admin.rka1.update', $rka->id) }}",
          data: formData,
          beforeSend:function() {
