...
<div class="main-content">
  <section class="section">
      ...
      <form action="{{ route('admin.rka1.store') }}" method="POST" id="form-rka">
      @csrf
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="unit_kerja" id="unit_kerja" class="form-control" {{ (auth()->user()->hasRole('Puskesmas') ? 'disabled' : '') }}>
